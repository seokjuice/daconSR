...
class ModelPlain(ModelBase):
    ...
    def define_loss(self):
        ...
        elif G_lossfn_type == 'mix_l1_l2':
            print("l1 loss and l2 loss used for training")
            self.G_lossfn_l1 = nn.L1Loss().to(self.device)
            self.G_lossfn_l2 = nn.MSELoss().to(self.device)
    ...
    def define_scheduler(self):
        ...
        elif self.opt_train['G_scheduler_type'] == 'step':
    ...
    def optimize_parameters(self, current_step):
        ...
        self.netG_forward()
        G_lossfn_type = self.opt_train['G_lossfn_type']
        if G_lossfn_type == 'mix_l1_l2':
            G_loss = self.G_lossfn_weight * self.G_lossfn_l1(self.E, self.H) + self.G_lossfn_weight * self.G_lossfn_l2(self.E, self.H)
        else:
